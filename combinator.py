...
#         (1,similaritymixer.SimilarityMixer.multi_kind_tup_sim(
#             wmd_simmilarity_mixer.wmd_similarity, assign={"SUBJECT":"CONTRAST"}),  -10, 1)], verbose=True)
#
# moments = similaritymixer.SimilarityMixer(
#     similarity_composition=[(1,similaritymixer.SimilarityMixer.multi_kind_tup_sim(
#         wmd_simmilarity_mixer.wmd_similarity, assign={"SUBJECT":"CONTRAST"}, layout='both'),  -10, 1)], verbose=True)
#
# analogs = similaritymixer.SimilarityMixer(
#                             [(1,similaritymixer.SimilarityMixer.multi_kind_tup_sim(wmd_simmilarity_mixer.wmd_similarity, n=4), -10, 1),
#                             (-20,similaritymixer.SimilarityMixer.multi_kind_tup_sim(similaritymixer.SimilarityMixer.same_expression_sim), 0, 1)])
...
def combine (nlp_annotated_annotations, sim, params):
    ...
    logging.info(f"number of annotations    {len(results)}s")
