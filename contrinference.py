...
def main(path):
    ...
    to_analyse = {
        'Contradicts': [combinator.contradicting,
                      {
                         'layout': 'n',
                         'n': 3,
                          'n_percent':0.2
    ...
    logging.info("CounterInference has to compare {len(nlp_annotated_annotations} "
    ...
    logging.info("CounterInference finished!")
...
if __name__ == '__main__':
    parser = ArgumentParser(description='finding counter inferences')
